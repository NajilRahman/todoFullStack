    ...
    return (
        <div className='card bg-light border border-0 my-2' style={{ minHeight: '250px' }}>
            ...
            <hr />
            {
                ...
                <Col sm={6}>
                    <button className='btn btn-dark border border-0 w-100 mb-1 'onClick={()=>updTask(data._id,data)} ><span className='me-2'>Completed</span><i class="  fa-regular fa-calendar-check text-success fa-xl"></i></button>
                </Col>
                <Col sm={6}>
